...
install_requires = ["aioredis", "psutil", "msgpack"]
NAME = "aplay"
PACKAGE = "aplay"
...
def read_version():
    ...
    init_py = os.path.join(os.path.dirname(__file__), "aplay", "__init__.py")
    with open(init_py) as f:
        for line in f:
            ...
            raise RuntimeError("Cannot find version in aplay/__init__.py")
